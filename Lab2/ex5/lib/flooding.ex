...
defp start(config, :cluster_start) do
  ...
  bind(peers, 0, [1, 6], 0)
  bind(peers, 1, [0, 2, 3], 1)
  bind(peers, 2, [1, 3, 4], 2)
  bind(peers, 3, [1, 2, 5], 3)
  bind(peers, 4, [2], 4)
  bind(peers, 5, [3], 5)
  bind(peers, 6, [0, 7], 6)
  bind(peers, 7, [6, 8, 9], 7)
  bind(peers, 8, [7, 9], 8)
  bind(peers, 9, [7, 8], 9)

  send Enum.at(peers, 0), {:hello, self(), -1}


end # start/2

defp bind(peers, node_num, neighbors, value) do
